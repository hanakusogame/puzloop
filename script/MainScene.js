...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            //タイム
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["time"], x: 5, y: 5 }));
            var labelTime = new g.Label({ scene: _this, font: numFont, fontSize: 32, text: "70", x: 45, y: 8 });
            ...
            //スコア加算表示
            var bkTweenScore;
            _this.addScore = function (num, time) {
                if (time === void 0) { time = 0; }
                if (score + num < 0) {
                    num = -score;
                }
                score += num;
                timeline.create().wait(time).call(function () {
